$(document).ready(function() {
  ...
  $("#formulario-registro").validate({
    ...
    messages: {
      ...
      apellido_m:{
        required: "El apellido materno es un campo requerido",
        soloLetras: "El apellido materno sólo puede contener letras y espacios en blanco",
      },
      apellido_p:{
        required: "El apellido paterno es un campo requerido",
        soloLetras: "El apellido paterno sólo puede contener letras y espacios en blanco",
      },
      correo: {
